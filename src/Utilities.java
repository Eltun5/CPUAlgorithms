...
public class Utilities {
    ...
    public static void takeElements() {
        ...
        Main.arrivalTimes = new int[Main.countOfElement];
        Main.burstTimes = new int[Main.countOfElement];

        for (int i = 1; i <= Main.countOfElement; i++) {
            System.out.print("Enter the arrival time of P" + i + " :");
            Main.arrivalTimes[i - 1] = sr.nextInt();

            while (Main.arrivalTimes[i - 1] < 0) {
            ...
            Main.burstTimes[i - 1] = sr.nextInt();

            while (Main.burstTimes[i - 1] < 0) {
                System.out.print("Please enter number equals or grater than 0 :");
                System.out.print("Enter the burst time of P" + i + " :");
                Main.burstTimes[i - 1] = sr.nextInt();
            }
